        ...
        {activeTab === 'dates' && (
          <div className="max-w-lg">
            <div className="rounded-xl border border-border-subtle bg-surface p-6 space-y-4">
              {[
                { label: 'Notification Published', date: 'June 15, 2025' },
                { label: 'Online Application Opens', date: 'June 18, 2025' },
                { label: 'Last Date to Apply', date: job.deadline, highlight: true },
                { label: 'Admit Card Release', date: job.examDate ? `4 weeks before exam` : 'TBA' },
        ...
        {activeTab === 'match' && (
          <div className="space-y-5 max-w-2xl">
            ...
            <div className="rounded-xl border border-border-subtle bg-surface p-5">
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-muted mt-1">Based on your profile: B.Tech Civil, Age 26, CG Domicile</p>
                </div>
              </div>
            </div>
            {/* Detail breakdown */}
            <div className="rounded-xl border border-border-subtle bg-surface p-5 space-y-3">
              ...
              {[
                { label: 'Qualification Match', met: true, detail: 'B.Tech Civil matches required qualification' },
                { label: 'Age Eligibility', met: true, detail: `Age 26 — within ${job.ageLimit}` },
                { label: 'State Domicile', met: job.state === 'Chhattisgarh', detail: job.state === 'Chhattisgarh' ? 'CG domicile — eligible' : 'UP domicile required — may need to check' },
                { label: 'Experience', met: true, detail: 'No prior experience required for this role' },
                { label: 'Additional Certification', met: false, detail: 'TET/CTET certificate not yet uploaded' },
              ].map((row) => (
            ...
            <div className="rounded-xl border border-brand-blue/20 bg-brand-blue/5 p-5">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-muted mt-1">Upload your TET/CTET certificate to improve your match score. Then apply before the deadline.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <div className="rounded-xl border border-border-subtle bg-surface p-5">
                ...
                <ul className="space-y-3">
                  {[
                    { label: 'Complete Reasoning syllabus', date: 'Jul 14' },
                    { label: 'First full mock test', date: 'Jul 21' },
                    { label: 'Admit card download', date: job.examDate ? 'Aug (estimated)' : 'TBA' },
        ...
        {activeTab === 'source' && (
          <div className="max-w-2xl">
            <div className="rounded-xl border border-border-subtle bg-surface p-6">
              ...
              <div className="space-y-3">
                {[
                  { date: 'June 15, 2025 08:00 AM', event: 'Notification published on official board website', source: 'Official Board Portal' },
                  { date: 'June 15, 2025 09:30 AM', event: 'Detected and ingested by OPPORTA', source: 'Automated scan' },
                  { date: 'June 16, 2025 10:00 AM', event: 'AI match analysis completed', source: 'AI Engine' },
                ].map((h, i) => (
