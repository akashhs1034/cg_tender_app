            ...
            <div className="space-y-4">
              <div className="rounded-xl border border-brand-blue/20 bg-brand-blue/5 p-5">
                ...
                <div className="flex items-end gap-2 mb-2">
                  ...
                  <p className="text-xs text-success mb-1">{tender.aiMatchScore >= 80 ? 'Strong match' : tender.aiMatchScore >= 60 ? 'Moderate match' : 'Low match'}</p>
                </div>
          ...
          <div className="max-w-2xl space-y-4">
            <div className="rounded-xl border border-border-subtle bg-surface p-6">
              ...
              {hasDocuments ? (
                ...
                <p className="text-sm text-text-muted">The required document list will appear here once parsed from the tender notice. Refer to the source portal for the authoritative list.</p>
              )}
            </div>
            <div className="rounded-xl border border-border-subtle bg-surface p-5">
              <div className="flex items-center gap-2 mb-3">
          ...
          <div className="space-y-5">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div className="rounded-xl border border-border-subtle bg-surface p-5">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-base font-semibold text-success">{tender.aiMatchScore >= 80 ? 'Strong Match' : tender.aiMatchScore >= 60 ? 'Moderate Match' : 'Low Match'}</p>
                    <p className="text-xs text-text-muted mt-0.5">Your profile aligns with this tender&apos;s requirements.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-brand-blue/20 bg-brand-blue/5 p-5">
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-text-primary">{tender.aiMatchScore >= 70 ? 'Bid with confidence' : 'Review carefully'}</p>
                    <p className="text-xs text-text-muted mt-1">
                      {tender.aiMatchScore >= 70
                        ? 'Your core eligibility looks strong. Verify documents and proceed to prepare your bid.'
                        : 'This tender is a weaker match. Confirm eligibility against the source document before investing effort.'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-xl border border-border-subtle bg-surface p-5">
                <p className="text-xs font-semibold text-text-muted uppercase tracking-wide mb-3">Quick Eligibility</p>
                <div className="space-y-2">
                  {tender.eligibility.slice(0, 5).map((item) => (
                    <div key={item} className="flex items-start justify-between gap-3 text-xs">
            ...
            <div className="rounded-xl border border-border-subtle bg-surface p-5">
              <div className="flex items-center justify-between mb-3">
                <p className="text-xs font-semibold text-text-muted uppercase tracking-wide">Bid Readiness</p>
          ...
          <div className="max-w-2xl">
            <div className="rounded-xl border border-border-subtle bg-surface p-6">
              ...
              <div className="space-y-3">
                {[
                  { event: 'Tender published on official portal', source: tender.source },
                  { event: 'Detected and ingested by OPPORTA', source: 'Automated scan' },
                  { event: 'AI analysis completed', source: 'AI Engine' },
                ].map((h, i) => (
