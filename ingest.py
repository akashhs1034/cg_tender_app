...
def run_live_scrapers():
    ...
    from scrapers import (
        ...
        gem, secl, pwd_cg, res_cg, cgwrd, uppcl, cppp_central, dprcg,
        samvad, cg_dept_sites,
    )
    ...
    _TENDER_SCRAPERS = [
        ...
        ("res_cg       (res.cg.gov.in)             ", res_cg.scrape),
        ("cg_wrd       (cgwrd.in)                  ", cgwrd.scrape),
        ("balrampur_cg (balrampur.gov.in)          ",
         cg_dept_sites.scrape_balrampur),
